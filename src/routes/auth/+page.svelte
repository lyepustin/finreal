...
<div class="min-h-screen bg-white dark:bg-gray-900 flex flex-col lg:flex-row">
  <!-- Image Section (desktop only) -->
  <div class="hidden lg:block lg:w-1/2 relative overflow-hidden">
    <div class="absolute inset-0 bg-gradient-to-r from-[#ccb7a4]/40 to-[#a89482]/40 z-10"></div>
    <img 
      src="/vaskia-cot.jpg" 
    ...
    <div class="relative z-20 flex h-full items-center justify-center p-8">
      <div class="text-center">
        <h2 class="text-3xl font-bold text-white mb-4 leading-tight">Don't Let Your Finances Get as Messy as a Wet Cat!</h2>
  ...
  <div class="w-full lg:w-1/2 flex items-center justify-center p-4 sm:p-8">
    <div class="w-full max-w-md">
      ...
      <div class="mb-6 lg:mb-8 text-center">
        <!-- Mobile cat logo -->
        <div class="lg:hidden relative w-40 h-40 mx-auto mb-4 overflow-hidden rounded-full">
          <div class="absolute inset-0 bg-gradient-to-r from-[#ccb7a4]/40 to-[#a89482]/40 z-10"></div>
          <div class="absolute inset-[-50%] overflow-hidden">
            <img 
              src="/vaskia-cot.jpg" 
              alt="Wet cat after bath" 
              class="absolute h-[200%] w-[200%] object-cover origin-center transform scale-[0.7] translate-x-3 -translate-y-4"
            />
          </div>
        </div>
        <!-- Desktop logo -->
        <div class="hidden lg:inline-flex items-center justify-center size-16 rounded-full bg-gradient-to-r from-[#ccb7a4] to-[#a89482] mb-4">
      ...
      <!-- Form Card -->
      <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-4 lg:p-6 border border-gray-200 dark:border-gray-700">
        <!-- Form -->
        <form method="POST" action={isSignUp ? "?/signup" : "?/login"} use:enhance>
          {#if form?.error}
            <div class="bg-red-50 border border-red-200 text-sm text-red-600 rounded-xl p-3 mb-4 dark:bg-red-800/10 dark:border-red-900/30 dark:text-red-500" role="alert">
          ...
          {#if form?.message}
            <div class="bg-green-50 border border-green-200 text-sm text-green-600 rounded-xl p-3 mb-4 dark:bg-green-800/10 dark:border-green-900/30 dark:text-green-500" role="alert">
              <div class="flex items-center gap-2">
          ...
          <!-- Email Input -->
          <div class="mb-4">
            <label for="email" class="block text-sm font-medium mb-1.5 dark:text-white">Your Human Email</label>
            <div class="relative">
              ...
              <input 
                ...
                name="email" 
                value={form?.email ?? ''} 
                class="py-2.5 px-4 ps-11 block w-full border-gray-200 rounded-lg text-sm focus:border-[#ccb7a4] focus:ring-[#ccb7a4] disabled:opacity-50 disabled:pointer-events-none dark:bg-gray-700 dark:border-gray-600 dark:text-gray-400 dark:focus:ring-gray-600" 
          ...
          <!-- Password Input -->
          <div class="mb-4">
            <label for="password" class="block text-sm font-medium mb-1.5 dark:text-white">Secret Paw-ssword</label>
            <div class="relative">
              <div class="absolute inset-y-0 start-0 flex items-center ps-3.5 pointer-events-none">
                <svg class="size-4 text-gray-500 dark:text-gray-400" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
